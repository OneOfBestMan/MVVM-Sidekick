...
namespace MVVMSidekick.ViewModels
{
    ...
    public abstract partial class ViewModelBase<TViewModel> : BindableBase<TViewModel>, IViewModel where TViewModel : ViewModelBase<TViewModel>
    {
        ...
        protected virtual async Task OnBindedToView(MVVMSidekick.Views.IView view, IViewModel oldValue)
        {
            ...
            if (view != null)
            {
                StageManager = ServiceLocator.Instance.ResolveFactory<IStageManager>(null, this);
                StageManager.CurrentBindingView = view;
                //StageManager(this) { CurrentBindingView = view };
        ...
        /// The _ stage manager
        /// </summary>
        IStageManager _StageManager = ServiceLocator.Instance.Resolve<IStageManager>();
        ...
        public IDispatcher Dispatcher
        {
            get
            {
                return ServiceLocator.Instance.ResolveFactory<IDispatcher>(null, this);
            }
        }
    }
